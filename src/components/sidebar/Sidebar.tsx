...
const Sidebar = (props: Props) => {
    ...
    const createMyDocumentsElements = () => {
        let elements: Array<ReactElement> = [];

        props.myDocuments.forEach(document => {
            elements.push(
                <div key={crypto.randomUUID()} className={styles.document}>
    ...
    return (
        <section id="SIDEBAR" className={styles.wrapper} aria-label="sidebar menu">
            <header>
                <svg className={styles.logo} viewBox="0 0 130 12" xmlns="http://www.w3.org/2000/svg">
            ...
            <footer>
                <svg width="17" height="16" xmlns="http://www.w3.org/2000/svg" 
                    className={props.isDarkMode ? styles.active : ""}>
